  ...
  return (
    ...
    <div className='flex flex-col justify-center align-middle items-center'>
        ...
        <div className="flex gap-1 w-11/12">
            <div className="w-1/4">
                <h1 className="bg-yellow-500 text-2xl pl-4 pt-4 font-bold rounded-t-lg">Chats</h1>
                <div id='chats' className='flex border border-2 border-b-black border-opacity-25 text-black text-lg'>
                    <img src='vite.svg'></img>
                    <div className=''><p>Mathew</p></div>
                </div>
            </div>
            <div className='flex-1'>
                <h1 className='bg-yellow-500 text-2xl pl-4 pt-4 font-bold rounded-t-lg'>Pending Requests</h1>
                ...
                <h1 className='bg-yellow-500 text-2xl pl-4 pt-4 font-bold rounded-t-lg'>People you might know</h1>
                    {/* <div id='current' className='border border-2 border-b-black border-opacity-25 text-black text-lg justify-between grid grid-cols-2'>
                        <div className='flex pl-3'><img src='vite.svg'></img>
                        <div className='pl-3'><p>Mathew</p></div></div>
                        <div className="gap-3 flex text-sm"><button className='mr-3 bg-blue-800 w-fit py-1 px-4 rounded-lg border border-yellow-500 border-3 text-white  hover:bg-white hover:text-black'>Accept</button><button className='mr-3 bg-blue-800 w-fit py-1 px-4 rounded-lg border border-yellow-500 border-3 text-white hover:bg-white hover:text-black'>Decline</button></div>  
